...
typedef NS_C512IR::Parser::token_type token_type;
...
/* This implementation of C51ExampleFlexLexer::yylex() is required to fill the
...
int C51ExampleFlexLexer::yylex()
{
    std::cerr << "in C51ExampleFlexLexer::yylex() !" << std::endl;
    return 0;
}
...
int C51ExampleFlexLexer::yywrap()
{
    return 1;
}
